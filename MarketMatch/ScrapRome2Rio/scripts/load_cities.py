...
# debug function
# cities_path = './generators2/r2rTrips/files/csv/worldcities.csv'
# tp_cities = gen_cities_combination(cities_path, debug=False, limit_cities=2, limit_combination=99, filter_diff_lat = 0, filter_diff_lng = 0)
# print(tp_cities)